...
router.post("/register", async (req,res)=>{
    const {name,email,phone,work,password,cpassword,college}= req.body
         if(!name || !email || !phone || !work||!password||!cpassword||!college){
        ...
        try{
           ...
           if(userexist){
            ...
            const user = new User({name,email,phone,work,password,cpassword,college})
            await user.save()
